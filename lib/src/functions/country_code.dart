/// Get country code
///
/// You can use this function to get country (dial) code from country name or dial code.
/// To search korea, you can search with
///   - Korea
///   - South Korea
///   - 82
///   - +82
...
///   - And so on.
///
/// [countryName] can be country name, country code or dial code.
/// [favorites] is list of country code. If you want to show favorite countries first, you can use this.
///
/// For favorite country code, "isFavorite: Y" will be added.
/// For Divider between favorites and other list, "isDivider: Y" will be added.
///

List<dynamic> countryCode(String? countryName, {List<String>? favorites}) {
  /// COPY FROM HERE
