...
class SupabaseService {
  ...
  bool get backupUsersPubicData => Config.instance.supa && Config.instance.supabase!.usersPublicData != null;
  bool get backupPosts => Config.instance.supa && Config.instance.supabase!.posts != null;
  bool get backupComments => Config.instance.supa && Config.instance.supabase!.comments != null;
}
