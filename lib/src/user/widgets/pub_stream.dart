...
class PubStream extends StatelessWidget {
  const PubStream({Key? key, this.login, this.logout}) : super(key: key);

  final Widget Function(UsersPublicDataRecord my)? login;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return login!(snapshot.data as UsersPublicDataRecord);
        });
  }
}
